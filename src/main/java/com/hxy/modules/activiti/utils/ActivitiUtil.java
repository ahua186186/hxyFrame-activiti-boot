...
public class ActivitiUtil {
    ...
    public static void TaskRollBack(String taskId){
        try {
            ...
            List<PvmTransition> nextTransitionList = currActivity
                    .getIncomingTransitions();//通过活动节点查询所有线路
            // 清除当前活动的出口
            ...
            for (PvmTransition nextTransition : nextTransitionList) {
                PvmActivity nextActivity = nextTransition.getSource();//获取线路的前节点
                //查找上一节点
     ...
     * @throws Exception
     */
    public static void turnBackNew(String taskId, String msg, String endActivityId) throws Exception {
        Map<String, Object> variables;
        // 取得当前任务
        HistoricTaskInstance currTask = historyService
                .createHistoricTaskInstanceQuery().taskId(taskId)
     ...
     */
    public static void jump(String taskId, String targetTaskDefinitionKey) throws WorkflowException{
        TaskEntity  currentTaskEntity = ActUtils.findTaskById(taskId);
        // 取得当前任务
        HistoricTaskInstance currTask = historyService
                .createHistoricTaskInstanceQuery().taskId(taskId)
                .singleResult();
        ...
        final ActivityImpl targetActivity = definition.findActivity(targetTaskDefinitionKey);
        ...
        /*Iterator<TaskEntity> localIterator = Context.getCommandContext()
                ...
                .findTasksByExecutionId(executionEntity.getId()).iterator();
     ...
     * @return 回退节点集合
     */
    public static List<ActivityImpl> iteratorBackActivity(String taskId,
     ...
     * @throws Exception
     */
    private static ProcessInstance findProcessInstanceByTaskId(String taskId)
            throws Exception {
        // 找到流程实例
