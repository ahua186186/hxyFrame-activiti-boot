...
public class KickoutSessionControlFilter extends AccessControlFilter {
    ...
    protected boolean onAccessDenied(ServletRequest request, ServletResponse response) throws Exception {
        ...
        RedisUtil2 redisUtil2= (RedisUtil2)SpringContextUtils.getBean("redisUtil2",RedisUtil2.class);
        RedisClusterUtil redisClusterUtil= (RedisClusterUtil)SpringContextUtils.getBean("redisClusterUtil",RedisClusterUtil.class);
        SessionManager sessionManager= (SessionManager)SpringContextUtils.getBean("sessionManager",SessionManager.class);
